    ...
    return (
        <section className={`${styles.QAM_Container} ${isOpen ? styles.open : styles.closed}`}>
            ...
            <nav className={styles.QAM_Nav}>
                <QAMItem text={"Home"} link={"/Home"} icon={<FontAwesomeIcon icon="fa-solid fa-house" className={styles.QAM_Item_Icon } />}></QAMItem>
                <QAMItem text={"To Do's"} link={"/ToDos"} icon={<FontAwesomeIcon icon="fa-solid fa-list-check" /> }></QAMItem>
            </nav>
        </section>
    )
}